...
const Sorting: React.FC<SortingDataTypes> = ({ onChange, sortType }) => {
  return (
    <select
      className='md:text-md text-sm w-full text-center sm:max-w-[300px] max-w-full dark:bg-gray-700 bg-transparent cursor-pointer border border-solid border-dark dark:text-offWhite relative z-10 rounded py-[8px] font-semibold'
      onChange={onChange}
      value={sortType}
    >
